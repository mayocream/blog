...
Kong 内部 dns 模块使用 **[lua-resty-dns-client](https://github.com/Kong/lua-resty-dns-client)**，这个库也是由 Kong 开源的，特色有 `toip` 函数会根据 dns 返回 ip 的权重配置加权轮询的权重，储存 dns 查询的结果在内存中。
